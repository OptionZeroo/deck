        ...
        <ul class="flex flex-col left-side gap-2 overflow-y-auto py-16">
            <li class="cursor-pointer group px-4">
                <a
                    ...
                    class="select-none flex flex-1 items-center p-2 rounded-lg gap-0.5 hover:bg-chillgray-100 dark:hover:bg-chillgray-900 ease-transition"
                >
                    <span
                        class="inline-block relative bg-white dark:bg-darkgray-950 rounded-lg p-1.5 shadow-xs"
                    >
            ...
            <li class="cursor-pointer group px-4">
                <a
                    ...
                    class="p-2 select-none flex flex-1 items-center rounded-lg gap-0.5 hover:bg-chillgray-100 dark:hover:bg-chillgray-900 ease-transition"
                >
                    <span
                        class="inline-block relative bg-white dark:bg-darkgray-950 rounded-lg p-1.5 shadow-xs"
                    >
