        ...
        <div class="col-span-1">
            <div class="form-control relative">
                <input
                    ...
                    class="input input-bordered h-10 pr-10 focus:ring-0 cursor-pointer text-csgray-700 dark:text-csgray-500 w-full border-b border-csgray-200 rounded-md dark:bg-darkgray-1000 dark:border-slate-50/[0.06]"
